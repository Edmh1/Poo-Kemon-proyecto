...
✔️ **Aleatorización real** de los mazos para evitar manipulaciones.  
✔️ **Aplicación automática** de reglas y mecánicas de batalla.  
✔️ **Interfaz gráfica intuitiva** para una experiencia inmersiva.  
✔️ **Persistencia de datos mediante serialización** para registrar partidas y estadísticas.  
✔️ **Seguridad** en la asignación de cartas y seguimiento de partidas.  
...
✔️ **Entrenador:** Representa a los jugadores en la batalla.  
✔️ **Pookémon:** Cada criatura con atributos de estadísticas, tipo y movimientos.  
✔️ **Movimiento:** Representa los ataques que pueden realizar los Pookémon.  
✔️ **Batalla:** Controla la lógica de combate entre dos jugadores.  
...
✔️ Se usó **Java Swing** para desarrollar una interfaz visual interactiva.  
✔️ Permite a los jugadores seleccionar sus acciones en la batalla con botones y paneles intuitivos.  
✔️ Muestra información en tiempo real sobre los Pookémon y la batalla.  
