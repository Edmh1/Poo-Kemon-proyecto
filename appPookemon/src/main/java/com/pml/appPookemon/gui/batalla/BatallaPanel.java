...
public class BatallaPanel extends StandarPanel {
    ...
    private TorneoController torneo = super.getMainFrame().getController();
    ...
    public void chequearGanador(){
        ...
        if(resultado != -1){
            cambio.dispose();
            if(resultado == 2){
                super.getMainFrame().switchToGanadorPanel(controlador.getEntrenador2().getNombreEntrenador());
            }else if(resultado == 1){
                super.getMainFrame().switchToGanadorPanel(controlador.getEntrenador1().getNombreEntrenador());
            }
        }
    }
