    ...
    public String realizarTurno(){
        ...
        if(accionEntrenador1.getTipoAccion() == TipoAccion.CAMBIAR_POKEMON){
            ...
            if(accionEntrenador2.getTipoAccion() == TipoAccion.ATACAR){
                resultado += entrenador2.getPookemonActual().getNombrePookemon() + " ha realizado el ataque " + entrenador2.getPookemonActual().obtenerMovimientoPorID(accionEntrenador2.idAccion).getNombreMovimiento();
                entrenador2.atacar(accionEntrenador2.idAccion, entrenador1.getPookemonActual());
            }
            return resultado;
        }
        ...
        if(accionEntrenador2.getTipoAccion() == TipoAccion.CAMBIAR_POKEMON){
            ...
            if(accionEntrenador1.getTipoAccion() == TipoAccion.ATACAR){
                resultado += entrenador1.getPookemonActual().getNombrePookemon() + " ha realizado el ataque " + entrenador1.getPookemonActual().obtenerMovimientoPorID(accionEntrenador2.idAccion).getNombreMovimiento();
                entrenador1.atacar(accionEntrenador1.idAccion, entrenador2.getPookemonActual());
            }
            return resultado;
        }
        ...
        if(accionEntrenador1.getTipoAccion() == TipoAccion.ATACAR && accionEntrenador2.getTipoAccion() == TipoAccion.DEFENDER){
            resultado += entrenador1.getPookemonActual().getNombrePookemon() + " ha realizado el ataque " + entrenador1.getPookemonActual().obtenerMovimientoPorID(accionEntrenador2.idAccion).getNombreMovimiento() + " ,pero el pookemon contrario se ha defendido";
        ...
        if(accionEntrenador2.getTipoAccion() == TipoAccion.ATACAR && accionEntrenador1.getTipoAccion() == TipoAccion.DEFENDER){
            resultado += entrenador2.getPookemonActual().getNombrePookemon() + " ha realizado el ataque " + entrenador2.getPookemonActual().obtenerMovimientoPorID(accionEntrenador2.idAccion).getNombreMovimiento() + " ,pero el pookemon contrario se ha defendido";
